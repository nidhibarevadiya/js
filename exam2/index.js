let products=[  {
  ...
  for(let i=0 ; i<products.length ; i++) {
    temp += `
<div class="box">
    <div class="center1"><h3>${products[i].title}</h3></div>
    <div class="cente"><p>${products[i].description}</p></div>
   <div class="center"> <p >${products[i].category}</p></div>
    <div class="center"><p >${products[i].price}</p></div>
